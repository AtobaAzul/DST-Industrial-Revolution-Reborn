...
local function fn()
    ...
    MakeDefaultItemNetworkableStructure(inst)
...
return Prefab("ir_node_item", fn, assets, prefabs),
    MakePlacer("ir_node_item_placer", "yotc_carrat_race_checkpoint", "yotc_carrat_race_checkpoint", "idle_off", false,
        nil, nil,
        nil, nil, nil, function(inst)
        return carratrace_common.PlacerPostInit_AddPlacerRing(inst, "ir_itemnetworkable")
    end)